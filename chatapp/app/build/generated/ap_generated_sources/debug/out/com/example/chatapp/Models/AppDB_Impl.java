  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Contact` (`username` TEXT, `lastMessage` TEXT, `userId` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `profilePic` INTEGER NOT NULL, `id` INTEGER NOT NULL)");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e78e406febdb703df869a4fa6f8d0824')");
      }
    ...
    }, "e78e406febdb703df869a4fa6f8d0824", "5f3045f0955341d7537fd016b2f175e3");
